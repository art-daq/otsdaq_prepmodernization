...
// If you are planning on specializing any methods you should inherit from BurstDataAndTimeSaverConsumerBase the same
// way this consumer is doing.
...
class BurstDataAndTimeSaverConsumer : public RawDataSaverConsumerBase {
 public:
  BurstDataAndTimeSaverConsumer(std::string supervisorApplicationUID, std::string bufferUID, std::string processorUID,
