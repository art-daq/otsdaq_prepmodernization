...
otsdaq-prepmodernization provides tools (Art modules, Data Processor plugins, ROOT DQM modules, Front-End interfaces, Data Generators, standalone interface tests, _artdaq_ Overlays, Slow Controls Interface plugins) in support of [PREP](https://prep.fnal.gov/) Modernization hardware.
