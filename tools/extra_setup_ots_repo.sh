...
echo "Your Database URI is now ARTDAQ_DATABASE_URI = ${ARTDAQ_DATABASE_URI}"
echo "Your User Web Path is now USER_WEB_PATH = ${USER_WEB_PATH}"
echo "(setup via prepmodernization)"
